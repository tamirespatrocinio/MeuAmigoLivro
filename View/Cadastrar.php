                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-md-10">
                        ...
                        <form method="POST">
                            ...
                            ?>
                                                <div class="container-fluid text-center mb-3 alert alert-success">Cadastrado realizado com sucesso! Acesse para entrar.</div>
                                            <?php
                                            } else {
                                            ?>
                                                <div class="container-fluid text-center mb-3 alert alert-danger">Email já cadastrado!</div>
                                            <?php
                                            }
                                        } else {
                                            ?>
                                            <div class="container-fluid text-center mb-3 alert alert-danger">Senhas não correspondem!</div>
                                        <?php
                                        }
                                    } else {
                                        ?>
                            ...
                            <div class="d-flex justify-content-center">
                                <button onclick="window.history.go(-1); return false" type="submit" value="Cancel" class="btn btn-login">Cancelar</button>
                                <button type="submit" value="Cadastrar" class="btn btn-cadastro">Cadastrar</button>
                            </div>
                        </form>
                    </div>
                </div>
